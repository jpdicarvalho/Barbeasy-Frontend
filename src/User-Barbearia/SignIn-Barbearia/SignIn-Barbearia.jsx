  ...
  return (
    <div className="container__default" translate="no">
      <form onSubmit={sendForm} className="container">
        ...
        <h2 id="HeaderSignIn" translate="no">Barbeasy</h2>
  
        {!pendingActivation ? (
          <>
            <h3 style={{ color: 'gray' }} translate="no">Login</h3>
            ...
            <div className='container__checkbox__professional'>
              ...
              />
              <label translate="no">Sou profissional</label>
            </div>
            ...
            <div className="link__signup">
              <p translate="no">Não tem uma conta?</p>
              <Link className="link" to="/SignUpBarbearia">Criar Conta</Link>
            </div>
            <div className="Box__forgot__password__in__barbearia" onClick={() => { navigate("/ResetPassword", { state: { userType: 'barbearia' } }) }} translate="no">
              Esqueci a senha
            </div>
          </>
        ) : (
          <div className="box__recover__account">
            <div className="Box__cadastro__barbearia">
              <h3 style={{ color: '#f6f6fc' }} translate="no">Recuperação de Conta</h3>
            </div>
            <p className="text__information__recover__account" translate="no">Já existe uma conta com ativação pendente para esse email ou celular informado. Deseja recuperá-la?</p>
            <button type="button" id="button_next" onClick={sendCodeAndRedirectUser} translate="no">Recuperar conta</button>
          </div>
        )}
      ...
      <footer className="footer">
        <div className="footer-links">
          ...
          <span className="footer-divider" translate="no">|</span>
