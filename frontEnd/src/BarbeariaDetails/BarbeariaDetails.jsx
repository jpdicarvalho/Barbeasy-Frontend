...
useEffect(() => {  
  const fetchData = async () => {
          try {
            const response = await fetch('https://barbeasy-backend-production.up.railway.app/listServico');
...
const Agendar = async () => {
    try {
      const response = await fetch('https://barbeasy-backend-production.up.railway.app/agendamento', {
        method: 'POST',
        headers: {
      ...
      const data = await response.json();
      alert(data.message);
      //window.location.href = 'https://barbeasy-backend-production.up.railway.app/Checkout';
    } catch (error) {
...
const pagamento = async () => {
    try {
      ...
      const response = await fetch('https://barbeasy-backend-production.up.railway.app/Checkout', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
...
const enviarAvaliacao = async () => {
    try {
      const response = await fetch('https://barbeasy-backend-production.up.railway.app/avaliacao', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
